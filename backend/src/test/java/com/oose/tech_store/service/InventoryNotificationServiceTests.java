...
class InventoryNotificationServiceTests {
    ...
    void whenProductOutOfStock_ObserversAreNotifiedWithOutOfStockTrue_AndNotificationsAreSaved() {
        // Arrange
        AffectedProductDTO product = new AffectedProductDTO("prod-123", "iPhone 16 (8GB / 256GB / Gold)", 8, 256, "Gold");
        ...
        when(favoriteProductRepository.findBySpecsAndStatus("prod-123", 8, 256, "Gold", SubscriptionStatus.SUBSCRIBED))
        ...
        ArgumentCaptor<InventoryStatusChangedEvent> eventCaptor1 = ArgumentCaptor.forClass(InventoryStatusChangedEvent.class);
        ArgumentCaptor<InventoryStatusChangedEvent> eventCaptor2 = ArgumentCaptor.forClass(InventoryStatusChangedEvent.class);
    ...
    void whenProductHasStock_ObserversAreNotifiedWithOutOfStockFalse_AndNoNotificationsAreSaved() {
        ...
        // Verify observers notified
        ArgumentCaptor<InventoryStatusChangedEvent> eventCaptor = ArgumentCaptor.forClass(InventoryStatusChangedEvent.class);
